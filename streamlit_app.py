...
if page == "Home":
    ...
    with col1:
        st.markdown(
            ...
            <p style="font-size: 16px;>Dataset: <a href="https://www.kaggle.com/datasets/nelgiriyewithana/australian-vehicle-prices" target="_blank">Australian Vehicle Prices on Kaggle</a></p>
            """,
